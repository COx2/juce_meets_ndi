...
set DST_FILE=.\Builds\%EXPORTER_NAME%\%ARCHITECTURE%\%BUILD_CONFIG%\%PLUGIN_FORMAT%\%SOLUTION_NAME%-%VERSION_NUMBER%.vst3
if exist "%SRC_FILE%" (
    move /y "%SRC_FILE%" "%DST_FILE%"
)
if %ERRORLEVEL% neq 0 goto FAILURE
